...
function showNext() {
  ...
  if (currSlide == 0) {
    ...
    if (askedAbout+1 == numAlters) {
      ...
      $("#contactMet2").text("With who has " + currNode.name.toUpperCase() + " Contact? By contact we mean all forms of contact, such as personal contact, contact via (mobile) telephone, post, email, text message, and other means of online and offline communication.");
